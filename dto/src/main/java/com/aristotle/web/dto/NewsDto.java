...
public class NewsDto {
    ...
    private String contentStatusString;
    ...
    public String getContentStatusString() {
        return contentStatusString;
    }

    public void setContentStatusString(String contentStatusString) {
        this.contentStatusString = contentStatusString;
    }
 ...
 + ", contentStatusString=" + contentStatusString + ", rejectionReason=" + rejectionReason + ", publishDate=" + publishDate + ", dateCreated="
				+ dateCreated + "]";
	}
