...
public class RefreshPlannedTweetRetweetCountBolt extends SpringAwareBaseBolt {
    ...
    public Result onExecute(Tuple input) throws Exception{
        ...
        logInfo("Message Recieved to update Tweet's Retweet count");
        twitterService.updatePlannedTweetRetweetCounts();
