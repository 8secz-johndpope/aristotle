...
@URLMapping(id = "adminEditUserRoleBean", beanName = "adminEditUserRoleBean", pattern = "/admin/roles", viewId = "/admin/admin_edituserrole.xhtml")
...
public class AdminEditUserRoleBean extends BaseMultiPermissionAdminJsfBean {
    ...
    private List<District> memberDistrictList;
    private List<AssemblyConstituency> memberAssemblyConstituencyList;
    private List<ParliamentConstituency> memberParliamentConstituencyList;
    private List<Country> memberCountryList;
    private List<CountryRegion> memberCountryRegionList;
    private List<CountryRegionArea> memberCountryRegionAreaList;
