...
public class ScheduleEvent extends DefaultScheduleEvent {
    ...
    public ScheduleEvent(Event eventDto) {
	...
	public ScheduleEvent(String title, Date start, Date end, Object data) {
		super(title, start, end, data);
	}
	public ScheduleEvent(String title, Date start, Date end, String styleClass) {
		super(title, start, end, styleClass);
	}
	public ScheduleEvent(String title, Date start, Date end) {
